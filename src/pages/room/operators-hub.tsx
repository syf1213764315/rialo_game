...
import { useWallet } from "../../components/wallet/FakeWalletContext";
...
import { FakeWalletMultiButton as WalletMultiButton } from "../../components/wallet/FakeWalletContext";
...
import { MOCK_SOL_PRICE, MOCK_WINNERS, MOCK_TOTAL_WINS, MOCK_TOTAL_COUNT } from "../../mock/data";
...
export default function Rooms(props: { isMute: boolean; setIsMute: Function }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-6 mt-[80px] xl:mt-[40px] flex flex-col xl:flex-row w-full xl:w-[calc(100%-300px)] mr-[300px]">
          <div className="w-full md:w-[calc(100%-300px)] xl:w-[450px] mt-6">
            ...
            <div className="flex flex-col border-[1px] bg-[#2e2a27] border-[#FFFFFF24] rounded-3xl px-6 backdrop-blur-md">
              ...
              <div className="flex flex-row mt-[13px] items-center gap-3">
                <input
                  ...
                  className="w-[calc(100%-118px)] h-12 border-[1px] bg-[#2e2a27] pl-5 border-white-10 rounded-xl text-[16px] text-[#FFFFFF]"
                />
                <button
              ...
              {(gameData?.players ?? []).length > 0 ? (
                <>
                  {wallet.publicKey ? (
                    <button
                      className="bg-[#c8bfa8] text-[#1a1918] xl:my-8 my-5 rounded-2xl text-[16px] xl:text-[20px] text-white-100 font-bold text-center xl:py-4 py-2"
                      onClick={handleBet}
        ...
        <div className="pl-4 pr-4 w-full md:w-[calc(100%-300px)] pb-20">
          ...
          <div className="flex flex-wrap mt-[18px] rounded-[8px] gap-[13px]">
            <div className=" relative flex flex-col pb-5 w-[calc((100%-40px)/3)] rounded-[8px] border-[1.33px] border-[#FFFFFF1A] backdrop-blur-sm">
              <div className="mt-6 ml-6 bg-[#c8bfa8] rounded-[8px] w-[46px] h-[46px]  md:block hidden"></div>
            ...
            <div className=" relative flex flex-col pb-5 w-[calc((100%-40px)/3)] rounded-[8px] border-[1.33px] border-[#FFFFFF1A] backdrop-blur-sm">
              <div className="mt-6 ml-6 bg-[#a89882] rounded-[8px] w-[46px] h-[46px] md:block hidden"></div>
              <p className="text-[24px] md:text-[32px] text-white-100 font-bold leading-[52px] mt-[13.35px] ml-6">
            ...
            <div className=" relative flex flex-col pb-5 w-[calc((100%-40px)/3)] rounded-[8px] border-[1.33px] border-[#FFFFFF1A] backdrop-blur-sm">
              <div className="mt-6 ml-6 bg-[#8a7e70] rounded-[8px] w-[46px] h-[46px] md:block hidden"></div>
              <p className="text-[24px] md:text-[32px] text-white-100 font-bold leading-[52px] mt-[13.35px] ml-6">
                {typeof data === "number"
      ...
      {isWonWindow && (
        <div className="fixed top-0 left-0 w-full h-full bg-[#1a1918a8] backdrop-blur-lg flex items-center justify-center z-50">
