...
export default function InfiniteBox(props: {
  ...
  useEffect(() => {
    ...
    // Only reset the spinning ball when a NEW round begins (gameEnded = false).
    // When gameEnded = true the animation may still be finishing; let it settle.
    if (!gameEnded) {
      setBallDeg(90);
    }
  }, [gameEnded]);
  ...
  return (
    <div className={props.className}>
      <h1 className="block xl:hidden text-center font-bold text-[50px] text-[#c8bfa8] mb-5 ml-5">
        Infinite Rug
      </h1>
      ...
      <div className="border-2 border-[#FFFFFF73] py-[75px] px-[94px] rounded-[30px] bg-[#2e2a27]">
        <div className="grid place-content-center">
          ...
          {gameData && gameData?.players && gameData?.players.length !== 0 ? (
            ...
            <div className="mx-8 rounded-xl border-[1px] border-[#ffffff50] bg-[#1a1918] py-5 mt-[25px] text-[14px] text-[#6a71f8] font-bold text-center">
