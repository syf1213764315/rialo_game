...
import { MOCK_SOL_PRICE } from "../mock/data";
import { useWallet } from "./wallet/FakeWalletContext";
...
export default function InfiniteBetBox(props: {
    ...
    return (
        <div className={props.className}>
            <div className="border-[1px] bg-[#2e2a27] border-[#FFFFFF24] rounded-3xl px-4 ">
                ...
                {(gameData?.players ?? []).length > 0 ? (
                    <>
                        {wallet.publicKey ? (
                            <button
                                className="bg-[#c8bfa8] text-[#1a1918] xl:my-5 my-3 rounded-2xl text-[16px] xl:text-[20px] text-white-100 font-bold text-center xl:py-4 py-2 w-full"
                                onClick={handleBet}
                    ...
                    <>
                        {wallet.publicKey ? (
                            <button
                                className="bg-[#c8bfa8] text-[#1a1918] xl:my-8 my-5 rounded-2xl text-[16px] xl:text-[20px] text-white-100 font-bold text-center xl:py-4 py-2  w-full"
                                onClick={handleBet}
                                disabled={isBetLoading}
                            >
                                {isBetLoading ? (
            ...
            <h1 className="hidden xl:block text-center font-bold text-[50px] text-[#c8bfa8] mt-5 ml-5">Infinite Rug</h1>
        </div>
    )
}